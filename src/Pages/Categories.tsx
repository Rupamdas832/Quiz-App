      ...
      <div className="flex flex-row flex-wrap justify-around w-full md:w-1/2 mt-10">
        {quizzes.map((quiz: Quiz) => {
          ...
          return (
            <div
              key={_id}
              className="w-40 h-40 mt-3 md:w-80 md:h-64 border-2 rounded-lg shadow-lg"
            >
              ...
              <div className="p-3 w-full flex flex-row justify-between items-center text-sm md:text-xl">
                <p>{title}</p>
                <button
                  className="text-xs md:text-lg p-1 px-2 rounded bg-blue-600 text-white md:hover:text-black md:hover:shadow-lg"
