  ...
  return (
    <div className="flex flex-col min-h-screen bg-blue-400 items-center p-5">
      <div className="flex flex-col items-center w-full md:w-1/2 bg-white p-5 rounded-b-3xl shadow-xl">
        <h1 className="text-3xl font-extrabold uppercase tracking-wider text-yellow-500 shadow-md">
          LeaderBoard
        </h1>
      ...
      <div className="w-full flex flex-col items-center">
        ...
        {quizzes.map((quiz: Quiz) => {
          ...
          return (
            <div
              key={_id}
              className="grid grid-cols-10 mt-3 w-full text-center py-3 bg-blue-600 text-white text-sm rounded shadow-md md:w-1/2 md:text-xl md:my-3 md:p-3"
            >
