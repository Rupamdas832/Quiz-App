  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col justify-center px-16 py-4 rounded-xl">
        <h1 className="text-3xl md:text-6xl font-medium text-blue-700">
          📚Grad Quizzy
        </h1>
        <div className="flex flex-col">
          <Link to="/categories">
            <button className="flex flex-row items-center w-full mt-5 px-5 py-2 text-left bg-white text-2xl rounded-xl hover:bg-blue-600 hover:text-white">
              <AiFillPlayCircle />
